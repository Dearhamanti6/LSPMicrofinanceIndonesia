        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="section-heading text-center mb-5">
                    <h3 class="display-2">Manage Pendaftaran Peserta</h3>
                    <p class="lead"></p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                            <a type="button" href="<?= base_url(); ?>/Manage_user_approve" class="btn btn-primary mb-4">Peserta Terdaftar <span id="countUserAdmin3Badge" class="badge bg-danger">Loading...</span></a>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    var table = $('#mu-table').DataTable({
                        ...
                        "order": [],
                        "ajax": {
                            "url": "<?php echo site_url('Manage_user/ajaxList') ?>",
                            "type": "POST",
                            "data": function(d) {
                    ...
                    function updateCount() {
                        $.ajax({
                            url: "<?php echo site_url('manage_user/countUserAdmin3'); ?>",
                            type: 'GET',
                            dataType: 'json',
                            success: function(response) {
                                // Update the badge text with the count
                                $('#countUserAdmin3Badge').text(response.count);
                            },
                    ...
                    // Initial call to update count on page load
                    updateCount();
                });
            </script>
            <?= $this->endSection() ?>
