                ...
                <div class="page-header-content text-start">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-left">
                        <ol class="breadcrumb breadcrumb-transparent breadcrumb-text-light mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Asesor Kompetensi</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<br>
<section class="services-section ptb-100 " style="padding: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                    <table id="ak-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class="bg-primary text-white"><strong>No</strong></th>
                                <th class="bg-primary text-white"><strong>Nama Asesor</strong></th>
                                <th class="bg-primary text-white"><strong>Nomor Registrasi</strong></th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#ak-table').DataTable({
            "processing": true,
            "serverSide": true,
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('AsesorKompetensiController/ajaxList') ?>",
                "type": "POST",
                "data": function(d) {
