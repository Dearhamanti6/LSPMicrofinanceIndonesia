		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post"  onsubmit="return checkValid()" action="<?=URL::base()?>/news/save">
						<div class="box-body">
							<?php
							...
							<div class="form-group">
								...
								<input type="text" name="title" value="<?php echo !empty($data['post']['title']) ? $data['post']['title'] : ''; ?>" minlength="3" maxlength="255" placeholder="<?php echo __('Only 90 Characters'); ?>" class="form-control" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea id="wysiwyg" class="form-control f_tinymce" rows="15" name="detail" minlength="3" required><?php echo !empty($data['post']['detail']) ? $data['post']['detail'] : '<strong style="color:#999">LSP Microfinance Indonesia - </strong>&nbsp;'; ?></textarea>
							</div>
						</div>
						<!-- /.box-body -->
