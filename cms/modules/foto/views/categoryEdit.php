		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-solid">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>ecommerce/category/update">
						<div class="box-body">
							<div class="form-group">
								<label for="exampleInputEmail1"><?php echo __('Name') ?></label>
								<input type="hidden" name="id" class="form-control" value="<?php echo $data['id']; ?>">
								<input type="text" name="name" class="form-control" placeholder="Lifestyle" value="<?php echo $data['name']; ?>">
							</div>
							<div class="form-group">
