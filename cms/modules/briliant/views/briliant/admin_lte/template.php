	...
	<body class="hold-transition skin-blue sidebar-mini fixed">
		...
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php echo ($menu_active == 'about') ? 'active' : ''; ?>">
							<a href="">
								<i class="fa fa-info-circle"></i> <span><?php echo __('Profil'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_about_lsp') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/about/content_about_lsp">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Profil LSP'); ?></span>
										</a>
									</li>
							</ul>
							<ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_visi_lsp') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/about/content_visi_lsp">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Visi dan Misi LSP'); ?></span>
										</a>
									</li>
							</ul>
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_organisasi') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/organisasi">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Struktur Organisasi'); ?></span>
										</a>
									</li>
							</ul>
						</li>
                        
                        <!-- <li class="treeview <?php echo ($menu_active == 'study') ? 'active' : ''; ?>">
							<a href="">
								<i class="fa fa-book"></i> <span><?php echo __('Study Visit'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_study_regular') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/study/content_study_regular">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Regular Study Visit'); ?></span>
										</a>
									</li>
							</ul>
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_study_customize') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/study/content_study_customize">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Customized Study Visit'); ?></span>
										</a>
									</li>
							</ul>
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_study_overseas') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/study/content_study_overseas">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Overseas Training'); ?></span>
										</a>
									</li>
							</ul>
						</li> -->
                        
                        <!-- <li class="treeview <?php echo ($menu_active == 'product') ? 'active' : ''; ?>">
							<a href="">
								<i class="fa fa-briefcase"></i> <span><?php echo __('Product And Services'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_product_research') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/product/content_product_research">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Research'); ?></span>
										</a>
									</li>
							</ul>
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_product_technical') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/product/content_product_technical">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Technical Assistance'); ?></span>
										</a>
									</li>
							</ul>
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_product_consultancy') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/product/content_product_consultancy">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Consultancy / Advocacy'); ?></span>
										</a>
									</li>
							</ul>
						</li> -->
                        
                        <!-- <li class="treeview <?php echo ($menu_active == 'empowerment') ? 'active' : ''; ?>">
							<a href="<?php echo URL::base(); ?>content/edit/empowerment/content_empowerment">
								<i class="fa fa-bullhorn"></i> <span><?php echo __('Empowerment'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
                        </li>
                        
                        <li class="treeview <?php echo ($menu_active == 'network') ? 'active' : ''; ?>">
							<a href="">
								<i class="fa fa-fighter-jet"></i> <span><?php echo __('Network'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_network_client') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/network/content_network_client">
											<i class="fa fa-circle-o"></i>
                            ...
                            <ul class="treeview-menu">
									<li class="treeview <?php echo ($menu_active_child == 'content_network_community') ? 'active' : ''; ?>">
										<a href="<?php echo URL::base(); ?>content/edit/network/content_network_community">
											<i class="fa fa-circle-o"></i>
											<span><?php echo __('Extended Community'); ?></span>
										</a>
									</li>
							</ul>
						</li> -->
						<li class="treeview <?php echo ($menu_active == 'events') ? 'active' : ''; ?>">
							<a href="">
								<i class="fa fa-newspaper-o"></i> <span><?php echo __('Events'); ?></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<!-- <ul class="treeview-menu">
								<li class="treeview <?php echo ($menu_active_child == 'converence') ? 'active' : ''; ?>">
									<a href="#">
										<i class="fa fa-circle-o"></i>
										<span><?php echo __('Converence'); ?></span>
										<i class="fa fa-angle-left pull-right"></i>
									</a>
									<ul class="treeview-menu">
										<li class="treeview <?php echo ($menu_active_child_1 == 'list') ? 'active' : ''; ?>">
											<a href="<?php echo URL::base(); ?>converence/search"><i class="fa fa-circle-o"></i> List</a>
										</li>
										<li class="treeview <?php echo ($menu_active_child_1 == 'add') ? 'active' : ''; ?>">
											<a href="<?php echo URL::base(); ?>converence/new"><i class="fa fa-circle-o"></i> Add New</a>
										</li>
									</ul>
								</li>
							</ul> -->
                            ...
                            <ul class="treeview-menu">
								<li class="treeview <?php echo ($menu_active_child == 'video') ? 'active' : ''; ?>">
									<a href="#">
										<i class="fa fa-circle-o"></i>
									...
									<ul class="treeview-menu">
										<li class="treeview <?php echo ($menu_active_child_1 == 'list') ? 'active' : ''; ?>">
											<a href="<?php echo URL::base(); ?>livestream/list"><i class="fa fa-circle-o"></i> List</a>
										</li>
										<li class="treeview <?php echo ($menu_active_child_1 == 'add') ? 'active' : ''; ?>">
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; <?php echo date('Y'); ?> <a href="https://lspmicrofinanceindonesia.co.id">LSP Microfinance Indonesia</a>.</strong> All rights reserved.
			</footer>
		</div>
		<!-- ./wrapper -->
		<!-- jQuery 2.1.4 -->
