<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<?php echo __('List Magazine'); ?>
		</h1>
		<ol class="breadcrumb">
			<li><?php echo __('E-magazine'); ?></li>
			<li class="active"><a href="/magazine/search"><?php echo __('E-Magazine'); ?></a></li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
							...
							<form method="post" id="publishForm">
								<label>Range 
									<select name="publisher" onChange="document.getElementById('publishForm').submit();">
										<option value="magazinePublishTime" <?php echo ($data['publish']!='magazinePublishTime'?'':'selected'); ?>>Publish</option>
										<option value="magazineSaved" <?php echo ($data['publish']!='magazineSaved'?'':'selected'); ?>>Saved</option>
									</select> Date
								</label>
							</form>
					...
					<div class="box-body">
						<a href="<?php echo URL::base(); ?>magazine/new"><button type="button" style="width:150px" class="btn btn-success btn-sm"><?php echo __('Add New Data'); ?></button></a>
					</div>
				</div>
				<div class="box box-primary">
