<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<?php echo __('E-Magazine'); ?>
		</h1>
		<ol class="breadcrumb">
			<li><?php echo __('E-Magazine'); ?></li>
			<li class="active"><a href="/magazine"><?php echo __('E-magazine'); ?></a></li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>magazine/update" enctype="multipart/form-data">
						<div class="box-body">
							<?php
							...
							<input type="hidden" name="old_path" value="<?php echo !empty($data['detail']['path']) ? $data['detail']['path'] : ''; ?>" id="">
							...
							<div class="form-group">
								<label><?php echo __('File PDF') ?> | <?php echo !empty($data['detail']['file']) ? $data['detail']['file'] : ''; ?></label>
						...
						<div class="box-footer">
							...
							<a href="<?php echo URL::Base(); ?>magazine"><button type="button" class="btn btn-danger"><?php echo __('Cancel'); ?></button></a>
						</div>
					</form>
				</div>
			</div>
