<div class="box-body">
	<table class="table table-bordered">
		<!-- List isi artikel -->
		<tr>
			<th style="width:210px;text-align:center;"><?php echo __('E-magazine Image'); ?></th>
		...
		if(!empty($data['list'])) {
			...
			foreach($data['list'] as $v_list) {
				...
				$button = '
					<td>
						<a href="' . URL::base() .'magazine/detail/' . $v_list['id'] . '"><button class="btn btn-block btn-success btn-xs">' . __('Preview') . '</button></a> </br>
						<a href="' . URL::base() .'magazine/edit/' . $v_list['id'] . '"><button class="btn btn-block btn-warning btn-xs">' . __('Edit') . '</button></a> </br>
