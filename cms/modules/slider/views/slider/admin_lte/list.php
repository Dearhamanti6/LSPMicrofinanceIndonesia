...
<div class="content-wrapper">
	...
	<section class="content">
        <div class="box box-primary">
			<div class="box-body">
				<a href="/slider/new"><button style="width:150px" class="btn btn-block btn-primary btn-sm">Add New Data</button></a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="box-body">
						<table class="table table-bordered">
							...
							<tr>
								...
								<th style="text-align:center;"><?php echo __('Sub Title'); ?></th>
