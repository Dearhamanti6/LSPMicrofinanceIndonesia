				...
				<div class="box box-primary">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>slider/update">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="exampleInputEmail1"><?php echo __('Subtitle') ?></label>
								<input type="text" name="sub_title_slider" class="form-control" value="<?php echo $data['sub_title']; ?>" required>
							</div>
						</div>
						<!-- /.box-body -->
