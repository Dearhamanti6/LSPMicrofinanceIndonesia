								...
								foreach($data['list'] as $v_list) {
									...
									if(!empty($v_list['fileType'])){
										...
										if(empty($data['dom'])){
											...
											$img = "<img style='width:200px;height:auto;' src='".URL::Base()."/uploads/library/".implode('/', $split_id)."/{$v_list['id']}{$size}.{$v_list['fileType']}'>";
											...
											$img_url="".URL::Base()."/uploads/library/".implode('/', $split_id)."/{$v_list['id']}_224x153.{$v_list['fileType']}";
