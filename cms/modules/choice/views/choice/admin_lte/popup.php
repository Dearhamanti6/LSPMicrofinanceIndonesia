<script type='text/javascript'>
    function paste(dom_id, id){
		...
		// Disable Scheduler
        //if(docref == 'http://myadmin.intisari.my.id/choice' || docref == 'http://myadmin.intisari.my.id/choice/' || docref == 'https://myadmin.intisari.my.id/choice' || docref == 'https://myadmin.intisari.my.id/choice/') {
                        ...
                        <div class="col-xs-12">
                                <div class="box box-primary">
                                        <div class="box-header with-border">
                                                ...
                                                <div class="box-tools">
                                                        <form method="post" action="/choice/popup/search">
                                                        ...
                                                        if(!empty($data['list_approved'])) {
                                                            ...
                                                            foreach($data['list_approved'] as $v_approved) {
                                                                ...
                                                                <tr <?php echo $bg_color; ?>>
                                                                        ...
                                                                        <td  width="10%">
                                                                                <a href="javascript:paste('dom_hidden', '<?php echo $v_approved['type']; ?>|<?php echo $v_approved['id']; ?>')"><button class="btn btn-block btn-success btn-xs">Push To Form</button></a><br/>
                                                                        </td>
                                                                </tr>
                                                                <?php
                                                                $i_c++;
