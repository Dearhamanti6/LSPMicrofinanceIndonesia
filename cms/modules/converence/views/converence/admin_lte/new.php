		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post"  onsubmit="return checkValid()" action="/converence/save">
						<div class="box-body">
							<?php
						...
						<div class="box-footer">
							...
							<a href="/converence"><button type="button" class="btn btn-danger"><?php echo __('Cancel'); ?></button></a>
						</div>
					</form>
					<!-- /.box-header -->
				</div>
