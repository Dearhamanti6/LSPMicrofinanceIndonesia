<div class="box-body">
	<table class="table table-bordered">
		<!-- List isi artikel -->
		<tr>
			<th style="width:210px;text-align:center;"><?php echo __('Article Image'); ?></th>
			<th style="text-align:center;"><?php echo __('Content'); ?></th>
		...
		if(!empty($data['list'])) {
			...
			foreach($data['list'] as $v_list) {
				...
				$button = '
					<td>
						<a href="' . URL::base() .'converence/detail/' . $v_list['id'] . '"><button class="btn btn-block btn-success btn-xs">' . __('Preview') . '</button></a> </br>
						<a href="' . URL::base() .'converence/edit/' . $v_list['id'] . '"><button class="btn btn-block btn-warning btn-xs">' . __('Edit') . '</button></a> </br>
