<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="/converence"><?php echo __('News'); ?></a></li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>converence/update">
						<div class="box-body">
							<?php
						...
						<div class="box-footer">
							...
							<a href="<?php echo URL::Base(); ?>converence"><button type="button" class="btn btn-danger"><?php echo __('Cancel'); ?></button></a>
						</div>
					</form>
				</div>
			</div>
