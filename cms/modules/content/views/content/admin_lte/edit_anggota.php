		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>content/update_anggota">
						<div class="box-body">
							<?php
							...
							<div class="form-group">
								...
								<input type="text" name="nama" value="<?php echo !empty($data['detail']['title']) ? $data['detail']['title'] : ''; ?>" maxlength="90" placeholder="<?php echo __('Only 90 Characters'); ?>" class="form-control" minlength="3" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label><?php echo __('Title') ?></label>
								<input type="text" name="jabatan" value="<?php echo !empty($data['detail']['position']) ? $data['detail']['position'] : ''; ?>" maxlength="90" placeholder="<?php echo __('Only 90 Characters'); ?>" class="form-control" minlength="3" required>
							</div>
