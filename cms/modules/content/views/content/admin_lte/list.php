<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<?php echo __('List Anggota'); ?>
		</h1>
		<ol class="breadcrumb">
			<li><?php echo __('Events'); ?></li>
			<li class="active"><a href="/news"><?php echo __('Struktur Organisasi'); ?></a></li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						<a href="<?php echo URL::base(); ?>content/new_anggota"><button type="button" style="width:150px" class="btn btn-success btn-sm"><?php echo __('Add New Data'); ?></button></a>
					</div>
				</div>
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="box-tools" style="float: right;">
							<form method="post" action="<?php echo URL::Base(); ?>content/organisasi">
